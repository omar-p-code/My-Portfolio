...
function project({ project }: { project: Project }) {
   ...
   return (
      ...
      active:-translate-y-2 active:border-(--secondary) active:scale-95 uppercase">
         ...
         <div className="overlay hover-show z-30 bg-(--card)/30 absolute top-0 left-0 w-full h-full flex items-center justify-center md:opacity-0 text-lg font-bold text-(--secondary) transition-opacity duration-400 cursor-pointer flex-col gap-6 p-5">
