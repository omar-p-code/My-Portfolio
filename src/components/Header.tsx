...
function Header() {
   ...
   return (
      <header className='sticky top-0 z-50 bg-(--card) border-b border-(--border) flex items-center justify-between py-5 px-10 max-md:px-5 h-[15vh]'>
         <div className="icon">
         ...
         <div className='flex '>
            <div className={`links`}>
               <div className={`nav overflow-hidden flex justify-center gap-2 items-center max-md:flex-col max-md:gap-1 max-md:w-full ${isMobile && `absolute top-[15vh] bg-(--card) left-0 rounded-none w-full border-y border-(--border) py-1`}`}>
                  {
                     links.map((link) => (
