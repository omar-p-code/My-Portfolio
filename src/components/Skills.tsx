...
function Skills({ className }: { className?: string }) {
   ...
   return (
      ...
      >
         ...
         <div className="skills min-w-full p-4 w-full overflow-hidden flex flex-col gap-15">

            <div ref={row1Ref} className="min-w-full flex flex-col flex-nowrap gap-4">
               <h2 className='text-3xl font-bold text-(--text)'>Frontend</h2>
            ...
            <div ref={row2Ref} className="min-w-full flex flex-col flex-nowrap gap-4">
               <h2 className='text-3xl font-bold text-(--text)'>Beckend</h2>
            ...
            <div ref={row3Ref} className="min-w-full flex flex-col flex-nowrap gap-4">
               <h2 className='text-3xl font-bold text-(--text)'>Tools</h2>
